...
console.log('P7_ACTION_SHA_PINNING_PASS');
console.log('P7_CODEQL_PUBLIC_GATE_PASS');
...
console.log('P7_RELEASE_PREFLIGHT_CONTRACT_PASS');
...
console.log('P7_OWNER_VISIBILITY_GATE_PASS');
...
console.log('P7_RELEASE_DOCS_PASS');
